...
class EventNotifier:
    def __init__(self):
        ...
        self.api_url = getattr(settings, "EVENT_API_URL", "https://extkong.spaasta.com/event-api/api/v1/push-event")
    ...
    def send_alert(self, result: DomainResult):
        ...
        try:
            ...
            log.warning(f"[이벤트 발송 성공] {evt_class} | {result.resource_id} | objectId: {object_id} | Level: {evt_level}")
